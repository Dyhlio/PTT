...
```bash
pip install git+https://github.com/Dyhlio/PTT.git
```
...
```bash
git clone https://github.com/Dyhlio/PTT.git
cd PTT
uv sync --all-extras
```
...
Contributions are welcome! Submit improvements through a [pull request](https://github.com/Dyhlio/PTT/pulls).
